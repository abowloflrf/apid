...
local apid on :19092) and rebuild before committing Go-visible changes.
Only the placeholder `server/webui/dist/index.html` is committed; the hashed
assets are build outputs and stay out of git (regenerated by the command above).
